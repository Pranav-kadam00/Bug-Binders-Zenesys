...
const demoRequests = [
  { id: 1, requestNumber: "PR-1048", title: "Q3 data center cooling upgrade", department: "Infrastructure", requester: "Maya Chen", priority: "High", budget: 1845000, requiredDate: "2025-08-18", status: "Pending approval", createdAt: "2025-06-12" },
  { id: 2, requestNumber: "PR-1047", title: "Field research equipment refresh", department: "Product Research", requester: "Jon Bell", priority: "Medium", budget: 428000, requiredDate: "2025-07-30", status: "In sourcing", createdAt: "2025-06-11" },
  { id: 3, requestNumber: "PR-1046", title: "Annual security assessment", department: "Security", requester: "Ari Singh", priority: "High", budget: 720000, requiredDate: "2025-07-14", status: "Approved", createdAt: "2025-06-10" },
  { id: 4, requestNumber: "PR-1045", title: "Studio collaboration licenses", department: "Design", requester: "Lena Ortiz", priority: "Low", budget: 129000, requiredDate: "2025-07-01", status: "Draft", createdAt: "2025-06-09" },
];
const demoVendors = [
...
function Landing() {
  const { isLoading } = useHealthCheck(); return <div className="min-h-[100dvh] bg-background text-foreground"><header className="mx-auto flex max-w-7xl items-center justify-between px-6 py-7 lg:px-10"><Logo /><div className="flex items-center gap-3"><Link href="/login" data-testid="link-landing-login" className="hidden px-4 py-2 text-sm font-semibold text-muted-foreground hover:text-foreground sm:block">Sign in</Link><Link href="/register" data-testid="link-landing-start" className="rounded-lg bg-primary px-4 py-2.5 text-sm font-bold text-primary-foreground shadow-sm hover:-translate-y-0.5">Start a workspace <ArrowRight className="ml-2 inline-block" size={15} /></Link></div></header><main>
    <section className="relative overflow-hidden border-b border-border"><div className="aqura-grid absolute inset-0 opacity-50" /><div className="relative mx-auto grid max-w-7xl gap-14 px-6 pb-24 pt-20 lg:grid-cols-[1.08fr_.92fr] lg:px-10 lg:pb-32 lg:pt-28"><div className="aqura-rise max-w-2xl"><div className="mb-7 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-3 py-1.5 text-[11px] font-bold uppercase tracking-[.13em] text-primary"><span className="h-1.5 w-1.5 rounded-full bg-primary" /> Decision intelligence for procurement</div><h1 className="font-serif text-[clamp(3.5rem,8vw,7rem)] font-bold leading-[.91] tracking-[-.055em]">Buy with<br /><span className="text-primary">the whole</span><br />picture.</h1><p className="mt-8 max-w-lg text-lg leading-8 text-muted-foreground">AQURA helps procurement teams move from request to confident purchase—by making the cost of uncertainty visible before it becomes yours.</p><div className="mt-9 flex flex-wrap items-center gap-4"><Link href="/register" data-testid="link-hero-start" className="rounded-lg bg-primary px-5 py-3 text-sm font-bold text-primary-foreground shadow-lg shadow-primary/15 hover:-translate-y-0.5">Enter your command center <ArrowRight className="ml-2 inline-block" size={16} /></Link><span className="text-xs text-muted-foreground">{isLoading ? "Connecting…" : "Live decision layer"} <span className="ml-1 inline-block h-1.5 w-1.5 rounded-full bg-primary" /></span></div></div><div className="aqura-rise aqura-delay-2 relative"><div className="absolute -inset-10 rounded-full bg-primary/10 blur-3xl" /><div className="relative rounded-2xl border border-border bg-card p-4 shadow-2xl shadow-foreground/10"><div className="flex items-center justify-between border-b border-border pb-4"><div><p className="font-mono text-[10px] uppercase tracking-[.16em] text-muted-foreground">Decision Twin / PR-1048</p><p className="mt-1 text-sm font-bold">Cooling infrastructure upgrade</p></div><Badge tone="teal">Analysis ready</Badge></div><div className="py-7"><div className="flex items-end justify-between"><div><p className="text-xs text-muted-foreground">True purchase cost</p><p className="mt-1 font-mono text-4xl font-bold">₹20,18,400</p></div><div className="text-right"><p className="text-xs text-muted-foreground">Quote selected</p><p className="mt-1 font-mono text-lg font-bold text-muted-foreground">₹18,45,000</p></div></div><div className="mt-6 h-2 rounded-full bg-muted"><div className="h-2 w-[72%] rounded-full bg-primary" /></div><div className="mt-2 flex justify-between text-[10px] text-muted-foreground"><span>Quote</span><span>Delay exposure +9.4%</span><span>Impact adjusted</span></div></div><div className="grid grid-cols-3 gap-2 border-t border-border pt-4">{[["Delay risk","12.8%","amber"],["Reliability","91 / 100","teal"],["Confidence","94%","teal"]].map(([l,v,t]) => <div key={l} className="rounded-lg bg-muted/60 p-3"><p className="text-[10px] text-muted-foreground">{l}</p><p className={`mt-1 font-mono text-sm font-bold ${t === "amber" ? "text-amber-700" : "text-primary"}`}>{v}</p></div>)}</div></div></div></div></section>
