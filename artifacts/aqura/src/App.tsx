...
function WorkspaceRouter() { return <Switch><Route path="/dashboard" component={Dashboard}/><Route path="/purchase-requests/new" component={NewRequest}/><Route path="/purchase-requests/:id" component={RequestDetail}/><Route path="/purchase-requests" component={Requests}/><Route path="/approvals" component={Approvals}/><Route path="/vendors/discover" component={Discover}/><Route path="/vendors/:id" component={VendorDetail}/><Route path="/vendors" component={Vendors}/><Route path="/vendor-comparison/:purchaseRequestId" component={()=><Comparison/>}/><Route path="/decision-twin/:purchaseRequestId" component={()=><Comparison twin/>}/><Route path="/purchase-orders/:id" component={OrderDetail}/><Route path="/purchase-orders" component={PurchaseOrders}/><Route path="/order-tracking" component={Tracking}/><Route path="/vendor-performance" component={VendorPerformance}/><Route path="/analytics" component={Analytics}/><Route path="/notifications" component={Notifications}/><Route path="/settings" component={Settings}/><Route component={NotFound}/></Switch>; }
